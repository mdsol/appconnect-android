...
An example of how to load these credentials from the `local.properties` file can be found in the sample app's [build.gradle](.../develop/app/build.gradle) file.
